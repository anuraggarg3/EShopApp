...
const Header = ({isCart,profileedit}) => {
  const navigation=useNavigation();
  return (
    <View style={styles.container}>
    <TouchableOpacity style={styles.appicon}
     activeOpacity={0.8} onPress={()=>{(isCart||profileedit)&&navigation.navigate("Home",{screen:"HomeScreen"})}}
    >{
      (isCart===true||profileedit===true)?(<Ionicons name="chevron-back-sharp" size={35} color={"darkblue"}/>)
    ...
    </TouchableOpacity>
    {
      ...
      :(profileedit===true)
      ?(<Text style={{fontSize:30,color:"black",fontWeight:"400"}}>My Profile</Text>):(null)
    }
